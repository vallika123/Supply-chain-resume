...
resume_file = current_dir / "pages" /"Vallika Kasibhatla resume supply chain.pdf"
...
core_skills = [
    {"label": "Supply Chain", "details": " Inventory Management, Demand Forecasting, Inventory Optimization"},
    ...
    {"label": "ERP Tool", "details": "SAP MM"},
     {"label": "Project Management", "details": "Microsoft Project, Access, Primavera, Risk Analysis, Contingency Planning, Cost/Benefit Analysis, Budgeting"},
    {"label": "Excel", "details": "Pivot Tables, VLOOKUP / HLOOKUP / XLOOKUP, Index-Match, Conditional Formatting"},
    {"label": "Data Analytics", "details": "Forecasting Methods, What-If Analysis, Safety Stock Calculations, Inventory Turnover Ratios"},
    {"label": "Data Visualization", "details": "Power BI, Dashboards, Charts, Graphs"},
...
with col1: 
    st.markdown(""" <br> Passionate about leveraging supply chain management and inventory planning strategies to optimize processes, streamline operations, and drive data-driven decision-making. Dedicated to addressing complex logistical challenges and delivering efficient, cost-effective solutions.
     """,
    unsafe_allow_html=True
    )
...
current_dir=Path(__file__).parent  if "__file__" in locals() else Path.cwd()
Paper1 = current_dir / "pages/CSCMP Supply Chain linkedln.pdf"
...
st.markdown(f"""
        <h5><strong> CSCMP Supply Chain, Inventory Management Professional Certificate </strong></h5>
        <p>The courses, Inventory Management Foundations, Excel Supply Chain Analysis: Solving Inventory Problems and Foundations of Working Capital Management covered key inventory management principles, techniques to solve supply chain challenges using Excel, and fundamental strategies in working capital management. The curriculum focused on optimizing stock levels, demand forecasting, cash flow management, and enhancing operational efficiency for supply chain processes.</p>
    """, unsafe_allow_html=True)
